...
<section id="iphone-function-section" class="section text-center iphone-function-section js-section" >
	...
	<div id="iphone-gallery-thumbnail-container" class="container text-center gallery-thumbnail-container" style="display:block;">
	...
	<div id="iphone-gallery-container" class="container modal-gallery" style="display:none;">
		<div class="row btn-container">
			...
			<div class="col-xs-8 col-sm-12 text-right close-btn">
				<a id="iphone-gallery-close">
					<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/cross.png"/>
				</a>
			</div>
		</div>
		<div id="iphone-function-containers">
			...
			<div class="row function-container">
				...
				<div class="col-xs-12 col-sm-7 col-sm-push-3 function-large-image-text-container">
					<h2>商品清晰分类，一目了然 </h2>
					<p>商品栏目清晰分类，既可以了解商品的细节图片，材质成分，搭配建议；也能通过品牌、颜色、尺寸筛选出您心仪的商品。</p>
				</div>
				<div class="col-xs-12 col-sm-3 col-sm-pull-7 text-right function-large-image-container">
					<img class="function-image" src="<?php echo Yii::app()->request->baseUrl; ?>/images/iphone-function-large-3.png"/>
				</div>
				<div class="col-sm-1 text-right large-device-next-btn">
					<a class="next-btn"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/right-arrow.png"/></a>
				</div>
			...
			<div class="row function-container">
				...
				<div class="col-xs-12 col-sm-7 function-large-image-text-container">
					<h2>轻松分享</h2>
					<p>随时将商品分享给身边好友，获得更多活动折扣。</p>
				</div>
				<div class="col-xs-12 col-sm-3 text-right function-large-image-container">
					<img class="function-image" src="<?php echo Yii::app()->request->baseUrl; ?>/images/iphone-function-large-4.png"/>
				</div>
				<div class="col-sm-1 text-right large-device-next-btn">
					<a class="next-btn"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/right-arrow.png"/></a>
				</div>
			...
			<div class="row function-container">
				...
				<div class="col-xs-12 col-sm-7 col-sm-push-3 function-large-image-text-container">
					<h2>多种支付，简便安全</h2>
					<p>我们提供安全的第三方支付---支付宝。也提供银联支付，无需注册，凭您在开卡银行的卡号与密码进行支付。无忧享受您的购物乐趣。</p>
				</div>
				<div class="col-xs-12 col-sm-3 col-sm-pull-7 text-right function-large-image-container">
					<img class="function-image" src="<?php echo Yii::app()->request->baseUrl; ?>/images/iphone-function-large-5.png"/>
				</div>
				<div class="col-sm-1 text-right large-device-next-btn">
					<a class="next-btn"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/right-arrow.png"/></a>
				</div>
			...
			<div class="row function-container">
				...
				<div class="col-xs-12 col-sm-6 function-large-image-text-container">
					<h2>同时提供iPad版本</h2>
					<p>凭您的拾裳账户便可在不同的设备中翻阅杂志，选购心爱之，物管理订单，跟踪到货状态，以及处理退换商品。轻松方便，随时随地！</p>
				</div>
				<div class="col-xs-12 col-sm-4 text-right function-large-image-container">
					<img class="function-image" src="<?php echo Yii::app()->request->baseUrl; ?>/images/iphone-function-large-6.png"/>
				</div>
				<div class="col-sm-1 text-right large-device-next-btn">
					<a class="next-btn"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/right-arrow.png"/></a>
				</div>
